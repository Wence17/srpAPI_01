...
/**
 * Admin onboarding tour steps (interactive guide).
 * @param t i18n translate function
 * @param isSimpleMode when true, group-related steps are filtered out
 */
export function getAdminSteps(t: (key: string) => string, isSimpleMode = false): DriveStep[] {
...
/** Regular user onboarding tour steps. */
