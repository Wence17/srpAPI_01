...
export default function PlatformIcon({ platform, size = 'sm' }: PlatformIconProps) {
  const sizeClass = `${sizeClasses[size]} flex-shrink-0`

  if (platform === 'anthropic') {
    return (
      <svg className={sizeClass} viewBox="0 0 16 16" fill="currentColor">
        <path
